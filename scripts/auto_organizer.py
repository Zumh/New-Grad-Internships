...
class READMEOrganizer:
    def __init__(self, filename, shortfilename):
    ...
    def organize_readme(self):
        try:
            ...
            print(f"{self.shortfilename} file not found.")
            return
        except PermissionError:
            print(f"Permission denied to read {self.shortfilename}.")
            return
        ...
        try:
            ...
            print(f"Permission denied to write to {self.shortfilename}")
            return

        print(f"{self.shortfilename} was organized successfully!")
...
if __name__ == "__main__":
    ...
    for file in listFiles: 
        ...
        organizer = READMEOrganizer(filename, file)
